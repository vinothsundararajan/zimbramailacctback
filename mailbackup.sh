...
EMAILTO="notify@mailsupport.com"

# Email account NOT to backup
EXCEPTIONS="galsync.@yourdomain.com;ham.@yourdomain.com;spam.@yourdomain.com;virus-quarantine.@yourdomain.com"
...
/opt/zimbra/postfix/sbin/sendmail -t "Backup Completed" "notify@mailsupport.com""<$LOGFILE
